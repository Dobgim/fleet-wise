/** The wordmark: "Motor" in the page's text colour, "Wise" in brand blue. */
export function Wordmark({ className = "" }: { className?: string }) {
  return (
    <span className={className}>
      Motor<span style={{ color: "var(--brand)" }}>Wise</span>
    </span>
  );
}
...
export function Logo({ size = 24 }: { size?: number }) {
  return (
    ...
    >
      ...
      <rect x="1" y="1" width="30" height="30" rx="9" fill="url(#mw-grad)" />
